package justfatlard.dead_heads.gametest;
...
public final class SmokeTest implements FabricClientGameTest {
	...
	public void runTest(ClientGameTestContext context) {
		if (!FabricLoader.getInstance().isModLoaded("dead-heads")) {
			throw new AssertionError("dead-heads is not loaded: the test is testing nothing");
		}
